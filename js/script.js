document.querySelectorAll('.style').forEach(function (item) {
  item.addEventListener('mousedown', function (e) {
    item.classList.add('styleOnClick');
  });
});

document.getElementById('allClear').addEventListener('mousedown', function () {
...
function clear() {
  const clearArray = calculation.textContent.toString().split('');
  clearArray.pop();
  calculation.textContent = clearArray.join('');
}
